...
class BxiExample(Node):
    def __init__(self, *, cpu_affinity_plan: CpuAffinityPlan):
        ...
        self._height_rate_snapshot = 0.0
        ...
        with self.lock_in:
            ...
            if self._joint_snapshot is None:
                ...
                self._observation = RobotObservation(
                    ...
                    raw_height_rate=self._height_rate_snapshot,
            ...
            self._height_rate_snapshot = self.raw_height_rate
            self._observation.raw_height_rate = self._height_rate_snapshot
    ...
    def joy_callback(self, msg):
        ...
        with self.lock_in:
            ...
            self.raw_height_rate = float(msg.vel_des.z)
